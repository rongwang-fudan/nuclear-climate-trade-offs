...
cou_iform=zeros(222,10);
cou_iform(:,1:6)=cou_iform2(:,1:6); clear cou_iform2;
cou_iform(:,8:10)=load('files\cn_add.txt');%1: land area(sq km) 2: Population ages 65 and above (% of total population) 3: Population ages 0-14 (% of total population)
cou_iform(:,11)=load('files\disc_rate_cn_add.txt');
